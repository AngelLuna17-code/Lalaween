...
const Footer = () => {
    return (
        <footer>
            <div className='' style={{ background: 'rgba(0, 0, 0, 0.7)', backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)'}}>
                <div>
                ...
                <div className="flex items-center justify-center space-x-10">
                    <a href="">
                        <svg className='text-white hover:text-[#00cac4]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
